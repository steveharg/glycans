...
\path{https://www.genome.jp/dbget-bin/www_bfind_sub?mode=bfind&max_hit=1000&locale=en&serv=gn&dbkey=glycan&keywords=*&page=1} \\

what's this one? \path{https://glyconnect.expasy.org/browser/structures/2259} \\

Note - GlycoCT seems to be 'dead' - was an EBI thing but funding ran out. Subsumed by \path{http://unicarb-db.expasy.org/} ? \\
